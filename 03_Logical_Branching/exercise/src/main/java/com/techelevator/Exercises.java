...
public class Exercises {
	...
	public boolean sleepIn(boolean weekday, boolean vacation) {
		// task states if it is not a weekday
		// AND not vacation you can sleep in
		if(!weekday && !vacation) {
			return true;
		...
		// task states if it is a weekday
		// AND it is vacation you can sleep in
		// if(weekday && vacation){
		//	return true;
		//}
		// task states if it is a weekday
		// and not vacation you can't sleep in
		//if(weekday && !vacation){
		//	return false;
		//}
		//if(!weekday && vacation){
	...
	public boolean loneTeen(int a, int b) {
		// if a is greater or equal to 13
		// if a is less than or equal to 19
		// and if b is less than 13
		// or if b is greater than 19 this returns true
		if (a >= 13 && a <= 19 && b < 13 | b > 19){
			return true;
		}
		// if b is greater or equal to 13
		// if b is less than or equal to 19
		// and if a is less than 13
		// or if a is greater than 19 this returns true
		if (a < 13 | a > 19 && b >= 13 && b <= 19) {
			return true;
		}
		// if a and b both are considered
		// 'teens' within the
		if (a >= 13 && a <= 19 && b >= 13 && b <= 19) {
			return false;
		}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
		if (isBirthday) {
			...
			if (mealAmount >= 10.01 && mealAmount <= 15.00) {
				return "special";
			}
			if (mealAmount > 15.00) {
				return "ginormous";
	...
	public int teaParty(int tea, int candy) {
		double teaCandy = tea / candy;
		double candyTea = candy / tea;
		if (tea < 5 || candy < 5) {
			return 0;
		}
		if(teaCandy >= 2 || candyTea >= 2){
			return 2;
		}
