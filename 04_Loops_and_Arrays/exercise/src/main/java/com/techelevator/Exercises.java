...
public class Exercises {
	...
	public boolean firstLast6(int[] nums) {
		int firstInSeries = nums[0];
		int lastInSeries = nums[nums.length - 1];
		if (firstInSeries == 6 || lastInSeries == 6) {
			return true;
		}
		return false;
	}
	...
	public boolean commonEnd(int[] a, int[] b) {
		int arrayA = a.length - 1;
		int arrayB = b.length - 1;
